...
class OrderViewSet(ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        # try:
        #     send_mail('Bill', 'Thank you for choosing us as your paper supplier', 'dundermifflin@domain.com', [request.user.email])
...
class ProductImageViewSet(ModelViewSet):
    ...
    # def download(self, request, product_pk, pk):
    #     instance = ProductImage.objects.get(product_id=self.kwargs['product_pk'], pk=self.kwargs['pk'])
